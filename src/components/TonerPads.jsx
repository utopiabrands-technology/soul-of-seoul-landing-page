...
export default function TonerPads() {
  ...
  return (
    <section
      id="toner-pads"
      className="product-detail-section toner-section section-shell"
    >
      <div className="product-section-top">
        ...
        <p>
          Targeted everyday formulas designed to make focused skincare easier to
          use.
        </p>
      </div>
      ...
      >
        <div className="toner-layout">
          <div className="toner-visual">
            <img
              key={active.visual}
              className="toner-model"
              src={active.visual}
              alt={`${active.name} beauty visual`}
            />
            <div
              className="ingredient-preview toner-preview-match glass-panel perspective-tilt-card"
          ...
          <div className="product-copy-panel glass-panel">
            ...
            <div className="pending-grid">
              ...
              <div>
                <span>USE</span>
                <p>
                  Apply evenly across face after cleansing, avoiding the eye
                  area.
                </p>
              </div>
            </div>

            <a className="glass-shop-button" href="#shop">
